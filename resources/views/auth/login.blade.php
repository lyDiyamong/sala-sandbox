<x-guest-layout>
    <div class="mb-4">
        <h2 class="text-xl font-medium">Let's get you in to Sala Sandbox</h2>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-4">
            ...
            <input id="email"
                ...
                type="email" name="email" placeholder="Please input your email address" value="{{ old('email') }}"
        ...
        <div class="mb-4 flex justify-end">
            <button type="submit"
                class="flex justify-center items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                Sign in
        ...
        <div class="text-center">
            <p class="text-sm text-gray-600">
                New to Sala Sandbox? <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-800">Create
                    an account</a>
            </p>
        </div>
    ...
    <div class="mt-6 text-center text-xs text-gray-500">
        <p>By selecting 'Sign in' you'll sign in to an <a href="#" class="text-blue-600">sala sandbox</a> agree to
